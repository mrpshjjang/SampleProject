...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty handleArrow;
    ...
    protected virtual void OnEnable()
    {
        ...
        handleArrow = serializedObject.FindProperty("handleArrow");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(handleArrow, new GUIContent("HandleArrow", "The handle's RectTransform component."));
    }
}